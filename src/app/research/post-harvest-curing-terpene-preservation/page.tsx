...
export default function Article() {
  ...
  "@type": "Article",
  "headline": "Post-Harvest Physiology: Curing and Volatile Compound Preservation",
  "description": "The science of moisture migration, chlorophyll degradation, and preventing monoterpene volatilization.",
  "author": {
    "@type": "Organization",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://www.oceangrownseeds.com/research/post-harvest-curing-terpene-preservation"
  }
}) }}
      />
      ...
      <div className="pt-8 px-4 md:px-8 max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none text-foreground/80 mb-16 space-y-6">
          <p>A cultivar&apos;s genetic potential is fully realized not at harvest, but at the conclusion of a careful curing process. The post-harvest phase involves complex physiological changes that dramatically impact the smokeability and aroma of the final product.</p>
