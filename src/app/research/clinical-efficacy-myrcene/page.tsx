...
export default function Article() {
  ...
  "@type": "Article",
  "headline": "Clinical Efficacy of β-Myrcene",
  "description": "Evaluating the analgesic, anti-inflammatory, and sedative pathways of the cannabis plant's most prevalent monoterpene.",
  "author": {
    "@type": "Organization",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://www.oceangrownseeds.com/research/clinical-efficacy-myrcene"
  }
}) }}
      />
     ...
     <p>Our hybridization protocols selectively breed for myrcene dominance in cultivars targeted at insomnia, chronic pain, and acute stress relief.</p>
          <p>Beyond its primary sedative effects, emerging studies indicate that myrcene may also play a crucial role in mitigating neuropathic pain. By interacting with the transient receptor potential cation channel subfamily V member 1 (TRPV1), myrcene exerts a peripheral analgesic effect that operates independently of the endocannabinoid system, offering a multi-targeted approach to pain management when combined with THC.</p>
        </div>
