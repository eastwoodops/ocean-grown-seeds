...
export default function Article() {
  ...
  "@type": "Article",
  "headline": "Landrace Preservation & Genetic Drift",
  "description": "The critical importance of conserving indigenous, unhybridized cultivars for agricultural biodiversity.",
  "author": {
    "@type": "Organization",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://www.oceangrownseeds.com/research/landrace-preservation-genetic-drift"
  }
}) }}
      />
      ...
      <div className="pt-8 px-4 md:px-8 max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none text-foreground/80 mb-16 space-y-6">
          <p>Landrace strains are indigenous varieties of cannabis that have adapted naturally to their specific geographical environments over centuries without intentional hybridization by humans (e.g., Hindu Kush, Thai, Durban Poison). These unadulterated genetics hold huge biodiversity.</p>
