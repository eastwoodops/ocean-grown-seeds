...
export default function Article() {
  ...
  "@type": "Article",
  "headline": "Polyploidy in Cannabis: Triploids and Yield",
  "description": "Exploring the induction of multiple chromosome sets to increase biomass, resin production, and genetic stability.",
  "author": {
    "@type": "Organization",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://www.oceangrownseeds.com/research/polyploidy-cannabis-triploids"
  }
}) }}
      />
