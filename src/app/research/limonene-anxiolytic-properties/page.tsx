...
export default function Article() {
  ...
  "@type": "Article",
  "headline": "D-Limonene: Anxiolytic & Uplifting Properties",
  "description": "Research highlighting the stress-relieving, immunostimulating, and mood-elevating mechanisms of Limonene.",
  "author": {
    "@type": "Organization",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://www.oceangrownseeds.com/research/limonene-anxiolytic-properties"
  }
}) }}
      />
      ...
      <div className="pt-8 px-4 md:px-8 max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none text-foreground/80 mb-16 space-y-6">
          <p>D-Limonene is a cyclic monoterpene that provides the distinct citrus, lemon, and lime aromatic profiles found in many sativa-leaning hybrids. Beyond its pungent olfactory footprint, limonene is heavily researched for its major effects on the central nervous system.</p>
     ...
     <p>Cultivars expressing high concentrations of Limonene are traditionally used for daytime use, targeted heavily at combatting lethargy, depressive episodes, and chronic stress.</p>
          <p>Also, limonene has shown promise in preliminary oncological research. Its ability to induce apoptosis in certain cancer cell lines, combined with its major safety profile and ability to stimulate the immune system by increasing white blood cell counts, positions it as a highly valuable therapeutic compound. Breeders aiming to maximize limonene often select for specific environmental stressors that upregulate the limonene synthase enzyme during late flowering.</p>
        </div>
