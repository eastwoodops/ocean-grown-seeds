...
export default function Article() {
  ...
  "@type": "Article",
  "headline": "Light Deprivation: Manipulating Photoperiods",
  "description": "The pros, cons, and physiological impacts of artificially inducing flowering cycles in greenhouse environments.",
  "author": {
    "@type": "Organization",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://www.oceangrownseeds.com/research/light-deprivation-photoperiod-manipulation"
  }
}) }}
      />
    ...
    <p><strong>Pros:</strong> This technique allows for multiple harvests per year using the power of the sun, greatly reducing the electrical overhead associated with indoor growing. It also enables cultivators to bring fresh product to market before the traditional fall &quot;Croptober&quot; glut.</p>
    <p><strong>Cons:</strong> Implementing automated blackout curtains requires significant capital expenditure. In fact, the abrupt manipulation of light cycles, combined with the heat trapped by blackout tarps, can induce abiotic stress. If humidity and airflow are not meticulously managed, this stress can lead to micro-climates conducive to Botrytis (bud rot) or trigger hermaphroditic responses in unstable genetics.</p>
